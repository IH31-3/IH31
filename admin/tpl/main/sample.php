<main>
    ...
    <form action="" method="post">
        <ul>
            <li>趣味：<input type="text" name="name" placeholder="趣味を入力"></input></li>
            <li>資格：<input type="text" name="age" placeholder="資格を入力"></input></li>
            <li>長所：<input type="text" name="gender" placeholder="長所を入力"></input></li>
            <li>短所：<input type="text" name="address" placeholder="短所を入力"></input></li>
        </ul>
